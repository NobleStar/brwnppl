...
CREATE TABLE "likes" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "story_id" integer, "user_id" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
CREATE TABLE "schema_migrations" ("version" varchar(255) NOT NULL);
CREATE TABLE "stories" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar(255), "description" text, "type" varchar(255), "url" text, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "user_id" integer, "image" varchar(255));
...
INSERT INTO schema_migrations (version) VALUES ('20120821002612');

INSERT INTO schema_migrations (version) VALUES ('20120907032511');